...
function Library.Render(settings)
    ...
    local Title = settings.Title or "Kidachi V2 | discord.gg/4YSVKEem6U | ".. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .."!";
...
-- end settings
        ...
        uiName.Text = "<font color=\"rgb(129, 145, 255)\">Kidachi V2 | discord.gg/4YSVKEem6U | ".. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .."!</font>"
